...
contract Calculator {
  ...
  constructor() public {
    adderContract = Adder(// contract address //0x82de6Ef0a8E7164B0CED019e7D61D51C69dE7590);
    suberContract = Suber(// contract address //0x10D4b95D72923411073b6095cd29B02696eD88A0);
  }
